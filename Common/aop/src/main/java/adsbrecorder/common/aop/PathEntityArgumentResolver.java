...
public class PathEntityArgumentResolver implements HandlerMethodArgumentResolver {
    ...
    private Map<Class<?>, Function<? super Number, ?>> idEntityResolverMap;
    private Map<Class<?>, Function<String, ? extends Number>> idDataConversionMap;

    public PathEntityArgumentResolver(Map<Class<?>, Function<? super Number, ?>> idEntityResolverMap) {
    ...
    public Object resolveArgument(MethodParameter parameter, ModelAndViewContainer mavContainer,
        ...
        try {
            ...
            if (pathVariables.containsKey(pe.name())) {
                ...
                Function<? super Number, ?> func = this.idEntityResolverMap.get(parameter.getParameterType());
                Number id = this.idDataConversionMap.get(pe.idDataType()).apply(paramValue);
                Object entity = func.apply(id);
                if (entity == null)
